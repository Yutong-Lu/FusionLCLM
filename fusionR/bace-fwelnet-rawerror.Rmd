...
split1_X_valid2 <- as.matrix(read.csv('split-1/processed_data/bace_X_ensemble_valid2_scaled_rawerror.csv'))
split1_y_valid2 <- as.matrix(read.csv('split-1/processed_data/bace_y_ensemble_valid2.csv'))

split1_X_test <- as.matrix(read.csv('split-1/processed_data/bace_X_ensemble_test_scaled_rawerror.csv'))
...
split2_X_valid2 <- as.matrix(read.csv('split-2/processed_data/bace_X_ensemble_valid2_scaled_rawerror.csv'))
split2_y_valid2 <- as.matrix(read.csv('split-2/processed_data/bace_y_ensemble_valid2.csv'))

split2_X_test <- as.matrix(read.csv('split-2/processed_data/bace_X_ensemble_test_scaled_rawerror.csv'))
...
split3_X_valid2 <- as.matrix(read.csv('split-3/processed_data/bace_X_ensemble_valid2_scaled_rawerror.csv'))
split3_y_valid2 <- as.matrix(read.csv('split-3/processed_data/bace_y_ensemble_valid2.csv'))

split3_X_test <- as.matrix(read.csv('split-3/processed_data/bace_X_ensemble_test_scaled_rawerror.csv'))
