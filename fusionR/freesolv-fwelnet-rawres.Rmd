...
split1_X_valid2 <- as.matrix(read.csv('split-1/processed_data/freesolv_X_ensemble_valid2_scaled_rawres.csv'))
split1_y_valid2 <- as.matrix(read.csv('split-1/processed_data/freesolv_y_ensemble_valid2.csv'))

split1_X_test <- as.matrix(read.csv('split-1/processed_data/freesolv_X_ensemble_test_scaled_rawres.csv'))
split1_y_test <- as.matrix(read.csv('split-1/processed_data/freesolv_y_ensemble_test.csv'))

# Define mean and standard deviation from training set
train_mean1 <- -4.170493506493507
train_sd1 <- 4.111818081202089
```
...
split2_X_valid2 <- as.matrix(read.csv('split-2/processed_data/freesolv_X_ensemble_valid2_scaled_rawres.csv'))
split2_y_valid2 <- as.matrix(read.csv('split-2/processed_data/freesolv_y_ensemble_valid2.csv'))

split2_X_test <- as.matrix(read.csv('split-2/processed_data/freesolv_X_ensemble_test_scaled_rawres.csv'))
split2_y_test <- as.matrix(read.csv('split-2/processed_data/freesolv_y_ensemble_test.csv'))

# Define mean and standard deviation from training set
train_mean2 <- -3.9326753246753245
train_sd2 <- 3.9386618472414696
```
...
split3_X_valid2 <- as.matrix(read.csv('split-3/processed_data/freesolv_X_ensemble_valid2_scaled_rawres.csv'))
split3_y_valid2 <- as.matrix(read.csv('split-3/processed_data/freesolv_y_ensemble_valid2.csv'))

split3_X_test <- as.matrix(read.csv('split-3/processed_data/freesolv_X_ensemble_test_scaled_rawres.csv'))
split3_y_test <- as.matrix(read.csv('split-3/processed_data/freesolv_y_ensemble_test.csv'))

# Define mean and standard deviation from training set
train_mean3 <- -3.8141818181818183
train_sd3 <- 3.6919888523133517
```
